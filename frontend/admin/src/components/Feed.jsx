...
export default function Feed() {
  ...
  const handleGlobalSim = async () => {
    if (!confirm("Are you sure you want to run a GLOBAL simulation? This will make EVERY bot interact with EVERY post. It might take a while!")) return;
      ...
      <div className="flex justify-between items-center mb-4">
        ...
        <button
            ...
            className={`px-4 py-2 rounded text-white font-bold transition ${
                isRunning ? 'bg-gray-400 cursor-not-allowed' : 'bg-red-600 hover:bg-red-700 shadow-md'
            }`}
        >
